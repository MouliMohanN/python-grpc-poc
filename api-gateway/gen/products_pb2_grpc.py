...
class ProductsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetProduct = channel.unary_unary(
                ...
                _registered_method=True)
        self.StreamProducts = channel.unary_stream(
                '/products.ProductsService/StreamProducts',
                request_serializer=products__pb2.StreamProductsRequest.SerializeToString,
                response_deserializer=products__pb2.Product.FromString,
                _registered_method=True)
...
def add_ProductsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'StreamProducts': grpc.unary_stream_rpc_method_handler(
                    servicer.StreamProducts,
                    request_deserializer=products__pb2.StreamProductsRequest.FromString,
                    response_serializer=products__pb2.Product.SerializeToString,
            ),
    }
...
class ProductsService(object):
    ...
    def StreamProducts(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/products.ProductsService/StreamProducts',
            products__pb2.StreamProductsRequest.SerializeToString,
            products__pb2.Product.FromString,
            options,
            channel_credentials,
            insecure,
